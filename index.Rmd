...
This website contains some of the results from TESS analysis using data of the Syntactic Atlas of Swiss German (SADS). These results provide supporting information for the main article _Linguistic traits as heritable units? Spatial Bayesian clustering reveals Swiss German dialect regions_. 

<h2>Tess results with $K = 6$</h2>
...
<h4>Read combined results with CLUMPP and merge them</h4>
```{r message=FALSE}
#Read clumpp results
